      ...
      <body className="font-sans">
        <NextIntlClientProvider messages={messages}>
          ...
          <footer className="mt-auto border-t border-slate-200 bg-white/70 backdrop-blur-md dark:border-white/10 dark:bg-[#0c0f10]/60">
            <div className="mx-auto flex max-w-4xl flex-col gap-2 px-4 py-6 text-sm text-slate-500 dark:text-slate-400 sm:flex-row sm:items-center sm:justify-between">
              <p>{t("tagline")}</p>
              <p>
